...
|country    | NVARCHAR(50)        |The country of resisdence for the customer (e.g, 'Australia'). |
|marital_status   | NVARCHAR(50)        |The marital status of the customer (e.g, 'Male', 'Female', 'n/a').|
...
|maintenance_required  | NVARCHAR(50)        |Indicates wheather the product requires maintenance (e.g., 'Yes', 'No').|
...
|shipping_date   | DATE       |The date when order was shipped to the customer. |
